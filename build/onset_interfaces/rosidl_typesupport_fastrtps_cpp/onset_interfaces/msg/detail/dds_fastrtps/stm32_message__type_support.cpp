...
#include "onset_interfaces/msg/detail/stm32_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const onset_interfaces::msg::STM32Message *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<onset_interfaces::msg::STM32Message *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _STM32Message__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const onset_interfaces::msg::STM32Message *>(
...
static size_t _STM32Message__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_STM32Message(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _STM32Message__callbacks = {
...
static rosidl_message_type_support_t _STM32Message__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_STM32Message__callbacks,
...
{
  return &onset_interfaces::msg::typesupport_fastrtps_cpp::_STM32Message__handle;
}
