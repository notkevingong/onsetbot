...
#include "onset_interfaces/msg/detail/onset_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_onset_interfaces
max_serialized_size_OnsetStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const onset_interfaces::msg::OnsetStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<onset_interfaces::msg::OnsetStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _OnsetStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const onset_interfaces::msg::OnsetStatus *>(
...
static size_t _OnsetStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_OnsetStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _OnsetStatus__callbacks = {
...
static rosidl_message_type_support_t _OnsetStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_OnsetStatus__callbacks,
...
{
  return &onset_interfaces::msg::typesupport_fastrtps_cpp::_OnsetStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, onset_interfaces, msg, OnsetStatus)() {
  return &onset_interfaces::msg::typesupport_fastrtps_cpp::_OnsetStatus__handle;
}
