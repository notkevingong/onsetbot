...
#include "odrive_can/msg/detail/o_drive_status__rosidl_typesupport_fastrtps_c.h"
...
using _ODriveStatus__ros_msg_type = odrive_can__msg__ODriveStatus;
  ...
  void * untyped_ros_message)
{
  ...
  _ODriveStatus__ros_msg_type * ros_message = static_cast<_ODriveStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: bus_voltage
  {
    cdr >> ros_message->bus_voltage;
  }
...
static uint32_t _ODriveStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_odrive_can__msg__ODriveStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = odrive_can__msg__ODriveStatus;
    is_plain =
      (
...
static size_t _ODriveStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_odrive_can__msg__ODriveStatus(
