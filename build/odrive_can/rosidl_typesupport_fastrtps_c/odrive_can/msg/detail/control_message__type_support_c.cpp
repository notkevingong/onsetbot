...
#include "odrive_can/msg/detail/control_message__rosidl_typesupport_fastrtps_c.h"
...
using _ControlMessage__ros_msg_type = odrive_can__msg__ControlMessage;
...
size_t get_serialized_size_odrive_can__msg__ControlMessage(
  const void * untyped_ros_message,
...
static uint32_t _ControlMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_odrive_can__msg__ControlMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_odrive_can
size_t max_serialized_size_odrive_can__msg__ControlMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = odrive_can__msg__ControlMessage;
    is_plain =
      (
...
static size_t _ControlMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_odrive_can__msg__ControlMessage(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, odrive_can, msg, ControlMessage)() {
