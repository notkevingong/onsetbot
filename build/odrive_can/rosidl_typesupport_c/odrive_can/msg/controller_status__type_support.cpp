...
static const _ControllerStatus_type_support_symbol_names_t _ControllerStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, odrive_can, msg, ControllerStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, odrive_can, msg, ControllerStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, odrive_can, msg, ControllerStatus)() {
  return &::odrive_can::msg::rosidl_typesupport_c::ControllerStatus_message_type_support_handle;
}
