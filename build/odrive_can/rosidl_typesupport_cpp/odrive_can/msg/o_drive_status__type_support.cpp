...
static const _ODriveStatus_type_support_symbol_names_t _ODriveStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, odrive_can, msg, ODriveStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, odrive_can, msg, ODriveStatus)),
  }
};
...
{
  return &::odrive_can::msg::rosidl_typesupport_cpp::ODriveStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, odrive_can, msg, ODriveStatus)() {
  return get_message_type_support_handle<odrive_can::msg::ODriveStatus>();
}
